...
sed -i -e "s|ADMIN_PASSWORD|$s|g" /home/oracle/create-wls-domain.py

# Create an empty domain
wlst.sh -skipWLSModuleScanning /home/oracle/create-wls-domain.py
mkdir -p ${DOMAIN_HOME}/servers/AdminServer/security/ 
echo "username=${ADMIN_USERNAME}" > /home/oracle/user_projects/domains/$DOMAIN_NAME/servers/AdminServer/security/boot.properties
echo "password=$s" >> /home/oracle/user_projects/domains/$DOMAIN_NAME/servers/AdminServer/security/boot.properties
